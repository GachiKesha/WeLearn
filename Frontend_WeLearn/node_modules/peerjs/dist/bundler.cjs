...
var $2QID2$cborx = require("cbor-x");
...
class $df9d8b89ee908b8b$var$Logger {
    ...
    log(...args) {
        if (this._logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.All) this._print($df9d8b89ee908b8b$export$243e62d78d3b544d.All, ...args);
    }
    warn(...args) {
        if (this._logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.Warnings) this._print($df9d8b89ee908b8b$export$243e62d78d3b544d.Warnings, ...args);
    }
    error(...args) {
        if (this._logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.Errors) this._print($df9d8b89ee908b8b$export$243e62d78d3b544d.Errors, ...args);
    }
    setLogFunction(fn) {
        this._print = fn;
    }
    _print(logLevel, ...rest) {
        ...
        if (logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.All) console.log(...copy);
        else if (logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.Warnings) console.warn("WARNING", ...copy);
        else if (logLevel >= $df9d8b89ee908b8b$export$243e62d78d3b544d.Errors) console.error("ERROR", ...copy);
    }
    constructor(){
        this._logLevel = $df9d8b89ee908b8b$export$243e62d78d3b544d.Disabled;
    }
}
...
const $0cb783f200ef4d91$var$NullValue = Symbol.for(null);
...
const $0cb783f200ef4d91$var$iterateOver = async function*(stream) {
...
class $0cb783f200ef4d91$export$7e9583c3c8a0a2cc extends (0, $544799118fa637e6$export$72aa44612e2200cd) {
    constructor(peerId, provider, options){
        super(peerId, provider, {
            ...options,
            reliable: true
            ...
            transform: (abchunk, controller)=>{
                ...
                try {
                    ...
                    for (let value of values || []){
                        if (value === null) value = $0cb783f200ef4d91$var$NullValue;
...
class $1fc1476c05a53911$export$f6a74c7ffa2903e6 extends (0, $2ddecb16305b5a82$export$ecd1fc136c422448) {
    constructor(...args){
        super(...args);
        this._serializers = {
